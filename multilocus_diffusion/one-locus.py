...
class PhysicsInformedNN:
    ...
    def __init__(self, f, t, phi, layers):
        ...
        self.f_tf = tf.placeholder(tf.float32, shape=[None, self.x.shape[1]])
        self.t_tf = tf.placeholder(tf.float32, shape=[None, self.t.shape[1]])
        
        self.phi_tf = tf.placeholder(tf.float32, shape=[None, self.u.shape[1]])
...
if __name__ == "__main__": 
    ...
    # Load Data # replace with something else (also will make .npy file)   
